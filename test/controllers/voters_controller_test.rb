...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { name: @voter.name, phonenum: @voter.phonenum, studentid: @voter.studentid } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { name: @voter.name, phonenum: @voter.phonenum, studentid: @voter.studentid } }
